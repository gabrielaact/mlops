...
This Python script implements a movie recommendation system. It allows users to input the 
name of a movie, and it provides recommendations based on that input. The recommendations are 
generated using TF-IDF (Term Frequency-Inverse Document Frequency) to find similar movie titles. 
Additionally, users can provide a movie ID to find movies that are similar based on user ratings.
...
Usage:
- Run this script to start the movie recommendation system.
- Enter the name of a movie to get recommendations based on the movie name.
- Optionally, you can enter a movie ID to find movies similar to it based on user ratings.
